...
EMAIL_USE_TLS = True
EMAIL_HOST = 'vishalsharma.impinge@gmail.com'
EMAIL_PORT = 587
EMAIL_HOST_USER = DEFAULT_FROM_EMAIL = os.environ.get('vishalsharma.impinge@gmail.com')
EMAIL_HOST_PASSWORD = os.environ.get('VisS@123')
